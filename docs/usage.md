...
Deploy the service catalog to the Wanaku router using `wanaku service deploy`:
...
# Package into a ZIP and Base64-encode it
cd finance && zip -r ../finance-catalog.zip . && cd ..
base64 < finance-catalog.zip > finance-catalog.b64
```
