...
The granularity on which these capabilities can operate is a decision left to the administrador of the system. For some 
...
> used in some places, specially in older documentation.
