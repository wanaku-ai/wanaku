...
public class ToolsHelper {
    ...
    public static ToolReference createToolReference(
            String name, String description, String uri, InputSchema inputSchema) {
    ...
    public static List<ToolReference> testFixtures() {
        InputSchema inputSchema1 = createInputSchema(
                "http", Collections.singletonMap("username", createProperty("string", "A username.")));

        ToolReference toolReference1 = createToolReference(
                "Tool 1", "This is a description of Tool 1.", "https://example.com/tool-1", inputSchema1);

        InputSchema inputSchema2 = createInputSchema(
                "https",
                Map.of(
                        "id",
                        createProperty("integer", "An order ID."),
                        "date",
                        createProperty("Date", "The date of the order.")));

        ToolReference toolReference2 = createToolReference(
                "Tool 2", "This is a description of Tool 2.", "https://example.com/tool-2", inputSchema2);
