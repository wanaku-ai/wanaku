...
package org.wanaku.cli.main.commands.targets.resources;

import java.util.Map;

import org.wanaku.cli.main.commands.targets.AbstractTargetsList;
...
public class ResourcesLinkedList extends AbstractTargetsList {
    ...
    public void run() {
        ...
        Map<String, String> list = linkService.resourcesList();
