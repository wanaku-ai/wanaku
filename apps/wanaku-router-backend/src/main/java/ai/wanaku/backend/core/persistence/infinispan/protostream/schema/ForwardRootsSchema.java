...
import ai.wanaku.backend.core.persistence.infinispan.protostream.marshaller.ForwardRootEntryMarshaller;
...
public class ForwardRootsSchema extends AbstractWanakuSerializationContextInitializer {
    ...
    public void registerMarshallers(SerializationContext serCtx) {
        serCtx.registerMarshaller(new ForwardRootEntryMarshaller());
