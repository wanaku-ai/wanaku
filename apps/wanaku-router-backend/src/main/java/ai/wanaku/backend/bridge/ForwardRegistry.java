...
public class ForwardRegistry {
    ...
    /**
     * Links a forward client to a service identifier with configured roots.
     *
     * @param service the service identifier (name and namespace pair)
     * @param forwardClientAddress the forward client address to register
     * @param roots the list of MCP roots for this forward, may be null or empty
     */
    ...
    /**
     * Retrieves the MCP roots configured for a service identifier.
     *
     * @param service the service identifier (name and namespace pair)
     * @return the list of MCP roots, or {@code null} if none configured
     */
    ...
    /**
     * Retrieves the MCP roots configured for a forward address.
     *
     * @param address the forward address to look up roots for
     * @return the list of MCP roots, or {@code null} if none configured
     */
